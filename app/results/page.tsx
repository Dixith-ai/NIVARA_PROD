                ...
                <div className="container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '60vh' }}>
                    <div className="card" style={{ textAlign: 'center', maxWidth: 480, padding: 'var(--space-12)' }}>
                        ...
                        <p style={{ color: 'var(--color-text-secondary)', fontSize: 'var(--font-size-sm)', marginBottom: 'var(--space-6)' }}>
                            Complete a demo scan to see your results here.
                        </p>
                ...
                <div className="container" style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-12)' }}>
                            ...
                            <div className={`card ${styles.primaryDiagCard}`} style={{ display: 'flex', alignItems: 'flex-start', gap: 'var(--space-4)', padding: 'var(--space-6)' }}>
                                ...
                                <div>
                                    ...
                                    <p style={{ color: 'var(--color-text-secondary)', fontSize: 'var(--font-size-sm)', lineHeight: 1.6 }}>
                                        Your scan image is analysed and is not stored on our servers. Only the diagnostic output is saved to your account.
                                    </p>
                                </div>
                            </div>
                    ...
                    <RevealSection>
                        ...
                        <div className={styles.diagnosisSection}>
                            ...
                            <div className={styles.summaryBlock}>
                                <p className={styles.summaryLabel}>What This Means</p>
                                <p className={styles.summaryText}>Your scan most strongly indicates {topCondition} at {topConfidence.toFixed(1)}% confidence. The conditions listed below are considered less likely based on the visual patterns detected. This is a screening result, not a clinical diagnosis. We recommend consulting a dermatologist to confirm these findings.</p>
                            </div>
                        </div>
                    </RevealSection>
                    ...
                    <RevealSection>
                        <div className="section-header" style={{ textAlign: 'left', marginBottom: 'var(--space-6)' }}>
                            ...
                            <h2 className={styles.sectionTitle} style={{ marginTop: 'var(--space-4)', marginBottom: 0 }}>While you wait for a consultation.</h2>
                        </div>
                        <div className="card">
                    ...
                    <RevealSection>
                        <div className={styles.disclaimer}>
                            ...
                            <div className={styles.disclaimerText}>
                                <span className={styles.disclaimerHeading}>Important</span>
                                <p className={styles.disclaimerBody}>
                                    This report is produced by an AI assisted screening system and is not a substitute for professional medical diagnosis. These results are a screening aid only. Please consult a qualified dermatologist for proper evaluation and treatment.
                                </p>
                            </div>
                        </div>
                    </RevealSection>
                    ...
                    <div className={`${styles.ctaCard}${isHigh ? ` ${styles.ctaCardUrgent}` : ''}`}>
                        <div className={styles.ctaInner}>
                            {isHigh ? (
                                ...
                                <span className="section-label section-label-light">Next Step</span>
                            )}
                            ...
                            <p className={styles.ctaCopy}>
                                {isHigh
                                    ? 'Your scan indicates a condition that may benefit from prompt professional attention. Please reach out to a dermatologist at your earliest convenience.'
                                    : 'A dermatologist can confirm these findings and recommend the right course of action. Book a consultation directly from here.'}
                            </p>
